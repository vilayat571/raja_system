  ...
  return (
    ...
    >
      <div className="flex flex-row items-start">
        <div className="p-8 xl:w-32 lg:w-32 md:w-32 sm:w-24 xl:h-32 lg:h-32 md:h-32 sm:h-24  bg-[#000000] flex justify-center items-center  rounded-full">
          {icon}
        </div>
        ...
        <div className="flex flex-col text-black tracking-wider ml-3">
          ...
          <p className="xl:text-2xl lg:text-2xl md:text-2xl sm:text-[16px] text-[#141414] py-2">{description}</p>
        </div>
      </div>
    </div>
  );
